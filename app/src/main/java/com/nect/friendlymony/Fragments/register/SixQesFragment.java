 ...
 */
public class SixQesFragment extends Fragment {
    ...
    public SixQesFragment() {
        // Required empty public constructor
    }

    public static Fragment newInstance() {
        SixQesFragment fragment = new SixQesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_six_qes, container, false);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnNext:
                ...
                ((SignupQuestionsActivity) getActivity()).loadFragment(FinalQesFragment.newInstance(), FinalQesFragment.class.getSimpleName(), true);
