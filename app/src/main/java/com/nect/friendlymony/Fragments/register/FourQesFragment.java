 ...
 */
public class FourQesFragment extends Fragment {
    ...
    public FourQesFragment() {
        // Required empty public constructor
    }

    public static Fragment newInstance() {
        FourQesFragment fragment = new FourQesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view==null) {
            ...
            view = inflater.inflate(R.layout.fragment_four_qes, container, false);
    ...
    @OnClick({R.id.btnNext, R.id.btnSkip,R.id.btnYes, R.id.btnNo, R.id.btnOccasion})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.btnNext:
                ...
                sm.setIsPolitics(isQes);
                HawkAppUtils.getInstance().setSIGNUP(sm);
                ((SignupQuestionsActivity) getActivity()).loadFragment(FiveQesFragment.newInstance(), FiveQesFragment.class.getSimpleName(), true);
