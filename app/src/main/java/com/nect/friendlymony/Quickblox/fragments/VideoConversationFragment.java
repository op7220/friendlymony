...
import com.nect.friendlymony.Quickblox.adapters.OpponentsFromCallAdapter;
...
public class VideoConversationFragment extends BaseConversationFragment implements Serializable,
    ...
    protected void initViews(View view) {
        ...
        if (!isPeerToPeerCall) {
            ...
            recyclerView.addItemDecoration(new DividerItemDecoration(getActivity(), R.dimen.space_1dp));
    ...
    private void setGrid(int columnsCount) {
        ...
        opponentsAdapter = new OpponentsFromCallAdapter(getContext(), this, opponents, cellSizeWidth, 136);
...
//      get opponentVideoTrack - opponent's video track from recyclerView
    ...
    class LocalViewOnClickListener implements View.OnClickListener {
        ...
        private void shiftMarginListOpponents() {
            ...
            params.setMargins(0, 0, 0, (int) getResources().getDimension(R.dimen.margin_all));
            recyclerView.setLayoutParams(params);
        }
    }
}