package com.nect.friendlymony.Quickblox.adapters;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull UsersAdapter.ViewHolder holder, int position) {
        ...
        if (selectedUsers.contains(user)) {
            holder.rootLayout.setBackgroundResource(R.color.grey_200);
            holder.opponentIcon.setBackgroundDrawable(
                    UiUtils.getColoredCircleDrawable(context.getResources().getColor(R.color.grey_200)));
