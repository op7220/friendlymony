package com.nect.friendlymony.Quickblox.services;
...
import com.nect.friendlymony.Quickblox.util.NetworkConnectionChecker;
import com.nect.friendlymony.Quickblox.utils.Consts;
import com.nect.friendlymony.Quickblox.utils.RingtonePlayer;
...
import static com.nect.friendlymony.Quickblox.utils.Consts.MAX_OPPONENTS_COUNT;
    ...
    private class SessionEventsListener implements QBRTCClientSessionCallbacks {
        ...
        public void onReceiveHangUpFromUser(QBRTCSession session, Integer userID, Map<String, String> map) {
            ...
            if (session == WebRtcSessionManager.getInstance(getApplicationContext()).getCurrentSession()) {
                ...
                QBUser participant = HawkAppUtils.getInstance().getQBUser();
