...
import com.nect.friendlymony.Quickblox.utils.CollectionsUtils;
import com.nect.friendlymony.Quickblox.utils.SharedPrefsHelper;
import com.nect.friendlymony.Quickblox.utils.UiUtils;
...
public class AudioConversationFragment extends BaseConversationFragment implements CallActivity.OnChangeAudioDevice {
    ...
    protected void configureOutgoingScreen() {
        ...
        allOpponentsTextView.setTextColor(ContextCompat.getColor(getActivity(), R.color.colorPrimaryDark));
        ringingTextView.setTextColor(ContextCompat.getColor(getActivity(), R.color.blue));
    }
    ...
    protected void configureToolbar() {
        ...
        toolbar.setTitleTextColor(ContextCompat.getColor(getActivity(), R.color.pink));
        toolbar.setSubtitleTextColor(ContextCompat.getColor(getActivity(), R.color.colorPrimaryDark));
    }
